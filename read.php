<?php
$dsn = 'mysql:dbname=heroku_ad9a8014a1ae4b5;host=us-cdbr-east-06.cleardb.net;charset=utf8mb4';
$user = 'bd1fe979521748';
$password = 'c955218a';
...
try {
  ...
  // bindValue()メソッドを使って実際の値をプレースホルダにバインドする（割り当てるわりあてる）
      ...
      <div class="products-ui">
        <div>
          <a href="read.php?order=desc&keyword=<?= $keyword ?>">
            <img src="images/desc.png" alt="高順に並び替え" class="sort-img">
          </a>
          ...
          <form action="read.php" method="get" class="search-form">
            ...
            <input type="text" class="serch-box" placeholder="商品名で検索" name="keyword" value="<?= $keyword ?>">
          </form>
        </div>
